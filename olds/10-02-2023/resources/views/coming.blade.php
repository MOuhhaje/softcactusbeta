...
<head>
    ...
    <link href="{{ asset('front/css/costum.css') }}" rel="stylesheet" />
    ...
    <script>
        ...
        const changeFavicon = () => {
            if (isDark.matches) faviconTag.href = "{{ asset('imgs/logo-white1.png') }}";
    ...
    <nav class="row navbar navbar-expand-lg navbar-light bg-light">
        <div class="col-md-7 col-lg-7 col-sm-12 container-fluid">
            <a class="navbar-brand" href="#" >
                {{-- full-logo-white.png --}}
                <img class="navbar-brand1" width="260px" src="{{ asset('imgs/full-logo-white.png') }}" alt="" />
                {{-- logo-white1.png --}}
                <img class="navbar-brand2" width="260px" src="{{ asset('imgs/logo-white1.png') }}" alt="" />
            </a>
        </div>
        ...
        <div class="row col-md-7 col-lg-7 col-sm-12 right-solution">
            ...
            <div class="sous-solution2">
                <p class="text3 ">
                    ...
                    Inspirée par le cactus dans sa résistance, autonomie, et sa force endurée par sa passion de fleurir en douceur face aux circonstances, la jeune entrepreneuse Hanae Dekhissi avait remarqué rapidement l'impact de l'environnement de travail sur les résultats, de ce constat est né le concept Soft Cactus, une série d'agences de communication partout dans le Maroc et ailleurs, pour accueillir avec empathie et agilité ses collaborateurs et talents aspirants travailler autour de valeurs communes : conseils et humains
            </p>
            </div>
        ...
        <div class="row col-md-7 col-lg-7 col-sm-12 service-left">
            ...
            <div class="row service1">
                ...
                <div class="col-11 sous-service2">
                    ...
                    <ul class="li1" >
                        <li><span>Création ou de refonte des:Sites vitrines, institutionnels et e-commerce</span></li>
                        ...
                        <li><span>Sécurisation de site</span></li>
                        <li><span>Maintenance corrective ou évolutive</span></li>
        ...
        <div class="row col-md-5 col-lg-5 col-sm-12 service-right">
            ...
            <div class="row service3">
                ...
                <div class="col-11 sous-service6">
                    <h5 class="titles">{{-- Design UX / UI --}} Branding </h5>
                    <ul class="li2">
                        <li><span>Charte Graphique</span></li>
                        <li><span>Charte éditoriale</span></li>
                        <li><span>Support de communication</span></li>
                        <li><span>Web design</span></li>
                        <li><span>UI Design</span></li>
                        <li><span>UX Design</span></li>
                        <li><span>Positionnement, repositionnement ou lancement de marque</span></li>
            ...
            <div class="row service4">
                ...
                <div class="col-11 sous-service8">
                    <h5 class="titles">Community Management{{-- Marketing des réseaux<br> sociaux --}}</h5>
                   
                        <ul class="li3">
                            <li><span>Stratégie de communication digitale 360°</span></li>
                            <li><span>Audit marketing digital</span></li>
                            <li><span>Benchmark concurrentiel</span></li>
                            <li><span>Veille et curation</span></li>
                            <li><span>Analyse et reporting</span></li>
                            <li><span>Etude de cible</span></li>

    ...
    <main class="container">
       ...
       <div class="row w-100">
            <div class="banner w-100">
                <img src="{{ asset('front/img/Kockpit-konsulting/Banner.png') }}" alt="">
            </div>
       </div>
       <div class="row w-100">
            <section id="panels">
                <div id="panels-container" style="width: 200%;">
                  <article id="panel-1" class="panel ">
                    <div class="container">
                      <div class="row">
                        <div class="col-6">
                          <img src="{{ asset('front/img/Kockpit-konsulting/Kockpit-konsulting-1.png') }}" alt="">
                        </div>
                      </div>
                    </div>
                  </article>
                  <article id="panel-2" class="panel ">
                    <div class="container">
                      <div class="row">
                        <div class="col-6">
                          <img src="{{ asset('front/img/Kockpit-konsulting/Kockpit-konsulting-2.png') }}" alt="">
                        </div>
                      </div>
                    </div>
                  </article>
       ...
       <div class="row w-100 align-items-center justify-content-between relative">
            ...
            <div class="hover-over-words overlay">
                <div class="text-1">
                   <p class="p1">
                    ...
                    <p class="p2" onclick="window.location.href='{{ route('GD') }}'">
                        go next
                    </p>
            ...
            <div class="img-tooltip">
                <a href="{{ route('GD') }}">
                    <img src="{{ asset('front/img/GD.png') }}" alt="" style="width: 100%;height: 100%;">
                </a>
            </div>
       </div>
    </main>

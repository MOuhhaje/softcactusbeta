    ...
    <main class="container">
       ...
       <div class="row w-100">
            <div class="banner w-100">
                <img src="{{ asset('front/img/Trasso/Banner.png') }}" alt="">
            </div>
       </div>
       <div class="row w-100">
            <section id="panels">
                <div id="panels-container" style="width: 100%;">
                  <article id="panel-1" class="panel ">
                    <div class="container">
                      <div class="row">
                        <div class="col-6">
                          <img src="{{ asset('front/img/Trasso/Trasso-1.png') }}" alt="">
                        </div>
                      </div>
                    </div>
                  </article>
       ...
       <div class="row w-100 align-items-center justify-content-between relative">
            ...
            <div class="hover-over-words overlay">
                <div class="text-1">
                   <p class="p1">
                    ...
                    <p class="p2" onclick="window.location.href='{{ route('BHS') }}'">
                        go next
                    </p>
            ...
            <div class="img-tooltip">
                <a href="{{ route('BHS') }}">
                    <img src="{{ asset('front/img/BHS.png') }}" alt="" style="width: 100%;height: 100%;">
                </a>
            </div>
       </div>
    </main>

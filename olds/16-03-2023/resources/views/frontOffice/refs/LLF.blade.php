    ...
    <main class="container">
       ...
       <div class="row w-100">
            <section id="panels">
                <div id="panels-container" style="width: 400%;">
                  ...
                  <article id="panel-4" class="panel ">
                    <div class="container">
                      <div class="row">
                        <div class="col-6">
       ...
       <div class="row w-100 align-items-center justify-content-between relative">
            ...
            <div class="hover-over-words overlay">
                <div class="text-1">
                   <p class="p1">
                    ...
                    <p class="p2" onclick="window.location.href='{{ route('Cleanco') }}'">
                        go next
                    </p>
            ...
            <div class="img-tooltip">
                <a href="{{ route('Cleanco') }}">
                    <img src="{{ asset('front/img/Cleanco.png') }}" alt="" style="width: 100%;height: 100%;">
                </a>
            </div>
       </div>
    </main>

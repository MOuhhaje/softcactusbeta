...
<?php $__env->startSection('content'); ?>
    ...
    <main class="who" id="who">
        ...
        <div class="right-who">
            ...
            <div class="content-r">
                <p class="prg1">Here goes a text that shows a good mix between
                    the mission and the vision put by Soft Cactus, it
                    shouldn’t be a long text, a minimum of 4 sentences
                    and a max of 5, just to make it easy to read and
                    beautiful in the design part .
                </p>

                <p class="prg2">
                    Here goes an even smaller text, showing the fact
                    that we specialise in Branding, web dev, and
    ...
    <div class="container" id="values">
        ...
        <div class="slide-container active">
            <div class="slide">
                ...
                <div class="image">
                    <img src="<?php echo e(asset('imgs/autonomie.jpg')); ?>" alt="">
                </div>
            </div>
            <div class="slide">
                <div class="content">
                ...
                <div class="image">
                    <img src="<?php echo e(asset('imgs/force.jpg')); ?>" alt="">
                </div>
            </div>
            <div class="slide">
                <div class="content">
                ...
                <div class="image">
                    <img src="<?php echo e(asset('imgs/resistance.png')); ?>" alt="">
                </div>
            </div>
            <div class="slide">
                <div class="content">
                ...
                <div class="image">
                    <img src="<?php echo e(asset('imgs/pexels-ann-h-1762851.png')); ?>" alt="">
                </div>
            </div>
        </div>
    ...
    <div class="team" id="team">
        <div class="left-team">
            ...
            <p>A small text talking about the team,
                how creative the team members
                are when it comes to everyones
                creativity, and expertise</p>
        </div>
        <div class="right-team">
            
            <img src="<?php echo e(asset('imgs/terrain.svg')); ?>" alt="">
        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontOffice.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/softcact/public_html/resources/views/frontOffice/whoweare.blade.php ENDPATH**/ ?>
            ...
            <div class="next-project">
                <div>
                    <a href="<?php echo e(route('chandelles')); ?>">
                        <img src="<?php echo e(asset('front/img/Chandelle.png')); ?>" alt="" style="width: 100%;height: 100%;">
                    </a>
                </div>
            </div>
       </div>
...
<?php echo $__env->make('frontOffice.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/softcact/public_html/resources/views/frontOffice/ref.blade.php ENDPATH**/ ?>
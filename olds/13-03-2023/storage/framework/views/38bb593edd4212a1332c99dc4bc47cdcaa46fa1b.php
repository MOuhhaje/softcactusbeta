    ...
    <main class="container">
       ...
       <div class="row w-100">
            <div class="banner w-100">
                <img src="<?php echo e(asset('front/img/LLF/Banner.png')); ?>" alt="">
            </div>
       </div>
       <div class="row w-100">      
                ...
                <div class="horizontal">
                    <section role="feed" class="cards">
                        <article class="sample-card revealer">
                            <img src="<?php echo e(asset('front/img/LLF/LLF-01.png')); ?>" alt="" >
                        </article>
                        <article class="sample-card revealer">
                            <img src="<?php echo e(asset('front/img/LLF/LLF-02.png')); ?>" alt="">
                        </article>
                        <article class="sample-card revealer">
                            <img src="<?php echo e(asset('front/img/LLF/LLF-03.png')); ?>" alt="">
                        </article>
                        <article class="sample-card revealer">
                            <img src="<?php echo e(asset('front/img/LLF/LLF-04.png')); ?>" alt="">
                        </article>
                    </section>
                </div>
                </div>
       ...
       <div class="row w-90 align-items-center justify-content-between">
            ...
            <div class="next-project">
                <div>
                    <a href="<?php echo e(route('Cleanco')); ?>">
                        <img src="<?php echo e(asset('front/img/Cleanco.png')); ?>" alt="" style="width: 100%;height: 100%;">
                    </a>
                </div>
            </div>
       </div>
...
<?php echo $__env->make('frontOffice.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/softcact/public_html/resources/views/frontOffice/refs/LLF.blade.php ENDPATH**/ ?>
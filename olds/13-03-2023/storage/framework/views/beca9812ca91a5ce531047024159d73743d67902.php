    ...
    <main class="service-content">
        <div class="sec-header" >
            <div class="title color-2">
                <H2>
                    <span class="color-text">Web Development<span class="color-3">.</span></span>
                </H2>
            </div>
            <div class="text">
                <p>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontOffice.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/softcact/public_html/resources/views/frontOffice/service-development.blade.php ENDPATH**/ ?>
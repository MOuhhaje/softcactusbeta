        ...
        <div class="row">
            <div class="col-sm-7 col-auto">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="<?php echo e(route('admin.offre')); ?>" style="color: #6C757D">Gestion des offres</a></li>
                    <li class="breadcrumb-item active"><a href="javascript::void(0)" style="color: #6C757D">Modification de l'offre</a></li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="col-sm-12">
            ...
            <div class="col-12 col-lg-9">
                <table class="table table-borderless">
                    <form action="<?php echo e(route('admin.offre.update',$offre->id)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <tr>
                        <th style="width: 180px">titre de l'offre :</th>
                        <td><input type="text" name="name_offre" class="form-control" value="<?php echo e($offre->name_offre); ?>"></td>
                    </tr>
                    <tr>
                        <th>Localisation :</th>
                        <td><input type="text" name="ville_offre" class="form-control" value="<?php echo e($offre->ville_offre); ?>" ></td>
                    </tr>
                    <tr>
                        <th>Type de contrat :</th>
                        <td><input type="text" name="type_offre" class="form-control" value="<?php echo e($offre->type_offre); ?>" ></td>
                    </tr>
                    <tr>
                        <th>border color :</th>
                        <td>                     
                            <div style="padding: 10px;background: white;border-radius: 10px; width: 65px;display: flex;align-items: center">
                                <div class="border_color_offre" style="background: <?php echo e($offre->border_color_offre); ?>;width: 30px; height: 30px;margin: 5px;border-radius:10px;"></div>
                                <input type="color" value="<?php echo e($offre->border_color_offre); ?>" id="border_color_offre" class="border_color_offre d-none" name="border_color_offre" style="width: 30px;height: 30px;border: none;"> 
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="langue_id" class="form-control">
                                ...
                                <?php if($langue->id == $offre->langue_id): ?> 
                                    <?php if($langue->name_langue == 'fr'): ?><option value="<?php echo e($langue->id); ?>" selected>Français</option> <?php else: ?>
                                    <option value="<?php echo e($langue->id); ?>" selected>Anglais</option><?php endif; ?>
                                <?php else: ?> 
                    ...
                    <tr>
                        ...
                        <td>
                            <textarea name="desc_offre" class="col-12 form-control bg-white desc_offre" style="border: none"><?php echo e($offre->desc_offre); ?></textarea>
                        </td>
                    </tr>
                    <tr>
                        <th>date message :</th>
                        <td><?php echo e($offre->created_at->format('Y-m-d H:m')); ?></td>
                    </tr>
                    <tr>
                        <th></th>
                        <td>
...
<?php endif; ?>
<?php /**PATH /home/softcact/public_html/resources/views/admin/gestion-des-offres/edit-offre.blade.php ENDPATH**/ ?>
...
<head>
    ...
    <title>Softcactus</title>
    <!-- Favicon-->
    <link rel="icon" type="image/x-icon" href="assets/mystyle/assets/logo-white1.png" />
    <!-- Core theme CSS (includes Bootstrap)-->
    <link href="assets/mystyle/css/costum.css" rel="stylesheet" />
    <link href="assets/mystyle/css/styles.css" rel="stylesheet" />
    ...
    <nav class="row navbar navbar-expand-lg navbar-light bg-light">
        <div class="col-md-7 col-lg-7 col-sm-12 container-fluid">
            <a class="navbar-brand" href="#" >
                <img class="navbar-brand1" width="260px" src="assets/mystyle/assets/full-logo-white.png" alt="" />
                <img class="navbar-brand2" width="260px" src="assets/mystyle/assets/logo-white1.png" alt="" />
            </a>
        </div>
...
<!--==================== c ====================-<?php /**PATH /home/softcact/public_html/resources/views/coming-soon.blade.php ENDPATH**/ ?>
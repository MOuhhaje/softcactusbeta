        ...
        <div class="row">
            <div class="col-sm-7 col-auto">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="javascript::void(0);" style="color: #6C757D">Nouveau Membre</a></li>
                </ul>
            </div>
        </div>
    </div>
            ...
            <div class="col-8">
                <table class="table table-borderless">
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="nom_member" class="form-control"></td>
                    </tr>
                    <tr>
                        <th>Prénom de membre :</th>
                        <td><input type="text" name="prenom_member" class="form-control"></td>
                    </tr>
                    <tr>
                        <th>Email de membre :</th>
                        <td><input type="email" name="email_member" class="form-control"></td>
                    </tr>
                    <tr>
                        <th>CIN de membre :</th>
                        <td><input type="text" name="cin_member" class="form-control"></td>
                    </tr>
                    <tr>
                        <th>intitulé du poste:</th>
                        <td><input type="text" name="intitule_poste" class="form-control"></td>
                    </tr>
                    <tr>
                        <th>Date de naissance de membre :</th>
                        <td><input type="date" name="date_naissance_member" class="form-control"></td>
                    </tr>
                    <tr>
                        <th>Adresse de membre :</th>
                        <td><input type="text" name="adresse_member" class="form-control"></td>
                    </tr>
                    <tr>
                        <th>Numéro de téléphone :</th>
                        <td><input type="text" name="phone_member" class="form-control" onkeypress='return event.charCode >= 48 && event.charCode <= 57'></td>
                    </tr>
                    <tr>
                        <th>Color image</th>
                        <td>
                            <div style="padding: 10px;background: white;border-radius: 10px; width: 65px;display: flex;align-items: center">
                                ...
                                <input type="color" value="#C508C5" id="border_color_offre" class="border_color_offre d-none" name="color_member" style="width: 30px;height: 30px;border: none;"> 
...
<?php endif; ?>
<?php /**PATH /home/softcact/public_html/resources/views/admin/gestion-de-la-team/add-team.blade.php ENDPATH**/ ?>